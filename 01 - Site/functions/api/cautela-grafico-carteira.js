// functions/api/cautela-grafico-carteira.js
...
export async function onRequestGet(context) {
    ...
    try {
        ...
        const smartResponse = await fetch(`https://api.smartsecurities.com.br/debenturista/cautela/grafico-carteira${queryString}`, {
            method: 'GET',
            headers: {
