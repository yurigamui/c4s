// functions/api/informe-rendimento-pdf.js
...
export async function onRequestGet(context) {
    ...
    try {
        ...
        const smartResponse = await fetch(`https://api.smartsecurities.com.br/debenturista/informe-rendimento/pdf${queryString}`, {
            method: 'GET',
            headers: {
