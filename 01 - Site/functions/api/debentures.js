...
export async function onRequestGet(context) {
    ...
    try {
        ...
        // Frontend usa /api/debentures, API Smart usa /debenturista/debenture
        const smartResponse = await fetch(`https://api.smartsecurities.com.br/debenturista/debenture${queryString}`, {
            method: 'GET',
            headers: {
