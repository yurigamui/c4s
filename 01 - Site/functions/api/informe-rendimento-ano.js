// functions/api/informe-rendimento-ano.js
...
export async function onRequestGet(context) {
    ...
    try {
        ...
        const smartResponse = await fetch(`https://api.smartsecurities.com.br/debenturista/informe-rendimento/ano${queryString}`, {
            method: 'GET',
            headers: {
